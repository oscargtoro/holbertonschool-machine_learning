...
This script index the _pd.DataFrames_ on the _Timestamp_ columns, concatenates them and rearrange the MultiIndex levels such that timestamp is the first level with the following criteria:
...
This script calculates descriptive statistics for all columns in pd.DataFrame except Timestamp. Executing this file, using Bitcoin's coinbase dataset from _2014-12-01_ to _2019-01-09_, should give this output:
